...
$query = "SELECT * FROM data_pasien ORDER BY id_pasien ASC";
...
if(isset($_POST["hapus"])) {
  ...
  $delete_query = "DELETE FROM data_pasien WHERE id_pasien='$id'";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="p-5 bg-body-tertiary rounded-3">
        <h4 class="text-body-emphasis text-center">Daftar pasien</h4>
        <!-- content -->
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th scope="col">penyakit pasien</th>
                    <th scope="col">jenis kelamin</th>
                    <th scope="col">umur pasien</th>
                    <th scope="col">password pasien</th>
                        ...
                        <tr>
                          ...
                          <td>
                              <form method="post">
                                  ...
                                  <?php echo "<td><a href='edit2_pasien.php?id_pasien=".$row['id_pasien']."'>Edit</a></td>"; ?>
                              </form>
                          </td>
                        </tr>
            </tbody>
