...
if(isset($_POST['submit'])) {
  ...
  if (isset($_POST['jk_pasien'])) {
    $jk_pasien = $_POST['jk_pasien'];
    // Lakukan sesuatu dengan nilai $jkAdmin
  } else {
    echo "<script>alert('Pilih jenis kelamin!');</script>";
  }

  // Validasi input
  if ($nama_pasien !== '' && $password_pasien !== '' && $jk_pasien !== '' && $umur_pasien !== '' && $penyakit_pasien !== '') {
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        $insert_query = "INSERT INTO data_pasien (nama_pasien, password_pasien, jk_pasien, umur_pasien, penyakit_pasien) VALUES ('$nama_pasien', '$password_pasien', '$jk_pasien', '$umur_pasien', '$penyakit_pasien')";
        ...
        <div class="offcanvas-body">
          ...
          <div class="dropdown mt-3">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="registrasi_pasien.php">obat pasien</a></li>
              </ul>
          </div>
    ...
    <div class="container my-5">
        <div class="p-5  bg-body-tertiary rounded-3">
          ...
          <form class="g-3 needs-validation" method="POST" novalidate>
            <div class="">
              <input type="text" class="" id="validationCustom01" name="nama_pasien" placeholder="nama pasien" required> <br><br>
            </div>
            <div class="">
                <input type="text" class="" id="validationCustom01" name="penyakit_pasien" placeholder="penyakit pasien" required> <br><br>
            </div>
            ...
            <div class="">
                <input type="text" class="" id="validationCustom01" name="umur_pasien" placeholder="nomor telepon" required> <br><br>
            </div>
            <div class="col-12">
