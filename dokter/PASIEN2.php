...
if (isset($_POST['submit_obat'])) {
    ...
    if ($id_pasien !== '' && $id_obat !== '') {
        // Query untuk memeriksa apakah data pasien ada di database dan terkait dengan dokter yang sedang login
        $query_pasien = "SELECT * FROM data_pasien WHERE id_pasien='$id_pasien' AND id_dokter='$id_dokter'";
        // $query = "SELECT * FROM data_pasien WHERE id_dokter = '$id_dokter' AND id_dokter='$id_dokter' ";
        $result_pasien = mysqli_query($conn, $query_pasien);

        // Jika data pasien ada di database dan terkait dengan dokter yang sedang login, lakukan insert data
        if (mysqli_num_rows($result_pasien) > 0) {
            ...
            echo "<script>alert('Data pasien tidak ditemukan atau Anda tidak memiliki akses ke pasien tersebut.')</script>";
        }
    } else {
...
<body>
          ...
          <div class="offcanvas-body">
            ...
            <div class="dropdown mt-3">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="PASIEN2.php">obat pasien</a></li>
              </ul>
            </div>
            ...
            <form method="POST" action="">
                ...
                <select name="id_pasien" required>
                    ...
                    <?php
                        ...
                        $query_get_pasien = "SELECT * FROM data_pasien WHERE id_dokter='$username'";
                        $query = "SELECT * FROM data_pasien WHERE id_dokter = '$id_dokter'";
                        $result_get_pasien = mysqli_query($conn, $query);
                ...
                <br><br>
                <button type="submit" name="submit_obat" class="btn btn-primary">Tambahkan Obat</button>
                <a  href="registrasi_pasien.php">kembali</a>
            </form>
        <!-- end form -->
      </div>
  </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-KDGoWCCYS/oxshh02pg5krY5iSZ2IaW6rfns8uLse1oG2RvI9rEM6F5/CzWO21MT" crossorigin="anonymous"></script>
</body>
</html>
